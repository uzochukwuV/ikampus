                      ...
                      {expandedModules && (
                        <div className="flex flex-col gap-0.5 mt-1 pl-6">
                          <button
                            ...
                            className={`flex items-center gap-3 px-3 py-2 text-[13px] apple-list-item text-left ${selectedModule === "General" ? "bg-neutral-100 font-medium" : "text-neutral-700"}`}
                          >
                            <span className={`w-1.5 h-1.5 rounded-full ${selectedModule === "General" ? "bg-blue-600" : "bg-neutral-500"}`}></span>
                            <span>General Assistant</span>
                          </button>
                          <button
                            onClick={() => {
                              setSelectedModule("MKT2006W1");
                              router.push("/");
                            }}
                            className={`flex items-center gap-3 px-3 py-2 text-[13px] apple-list-item text-left ${selectedModule === "MKT2006W1" ? "bg-neutral-100 font-medium" : "text-neutral-700"}`}
                          >
                            <span className={`w-1.5 h-1.5 rounded-full ${selectedModule === "MKT2006W1" ? "bg-blue-600" : "bg-neutral-500"}`}></span>
                            <span>MKT2006W1</span>
                          </button>
                          <button
                            onClick={() => {
                              setSelectedModule("MKT2050W");
                              router.push("/");
                            }}
                            className={`flex items-center gap-3 px-3 py-2 text-[13px] apple-list-item text-left ${selectedModule === "MKT2050W" ? "bg-neutral-100 font-medium" : "text-neutral-700"}`}
                          >
                            <span className={`w-1.5 h-1.5 rounded-full ${selectedModule === "MKT2050W" ? "bg-blue-600" : "bg-neutral-500"}`}></span>
                            <span>MKT2050W</span>
                          </button>
                          <button
                            onClick={() => {
                              setSelectedModule("MKT2011W");
                              router.push("/");
                            }}
                            className={`flex items-center gap-3 px-3 py-2 text-[13px] apple-list-item text-left ${selectedModule === "MKT2011W" ? "bg-neutral-100 font-medium" : "text-neutral-700"}`}
                          >
                            <span className={`w-1.5 h-1.5 rounded-full ${selectedModule === "MKT2011W" ? "bg-blue-600" : "bg-neutral-500"}`}></span>
                            <span>MKT2011W</span>
                          </button>
                        </div>
                      )}
